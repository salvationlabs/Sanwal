		...
		try:
			...
			if not user.is_active and not user.is_verified:
				...
				message = render_to_string(
					"account/registration/account_verification_resent_email.html",
					{
						"user": user,
				...
				messages.info(
					self.request,
					"A verification email has been resent. Please check your email and activate your account.",
				)
...
def register(request):
	...
	if request.method == "POST":
		...
		if registerForm.is_valid():
			...
			messages.success(
				request,
				"Your account has been created successfully. Please check your mail for account verification",
			)
			return redirect("store:index")
